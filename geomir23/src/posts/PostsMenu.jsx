...
export const PostsMenu = () => {
  ...
  return (
    ...
    <input
      ...
      <button onClick = { (e)=> {e.preventDefault(); dispatch(setFilter ( { ...filter , body: filtre}))} }        
    ...
    <button onClick={()=>{ dispatch(setFilter({ body:"", author:""}))}}  className={ !qui ? "text-white font-bold py-2 px-4 h-10 md:h-10 bg-red-500 hover:bg-red-700" : "text-white font-bold py-2 px-4 h-10 md:h-10 bg-orange-200 hover:bg-orange-700" }>
    Esborrar Filtres
    </button>
    </div>
    </div>
