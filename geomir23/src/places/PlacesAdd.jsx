...
export const PlacesAdd = ({ setAfegir }) => {
  ...
  const { info, error, isLoading } = useSelector((state) => state.places);
    ...
    <>
      <div className="py-9 pl-9">
        ...
        <div className="w-1/3">
          ...
          <div className="py-9">
            {isLoading ? (
              <button className=" bg-red-500 hover:bg-red-700 text-red-700 font-bold py-2 px-4 rounded-full">
                Afegir Entrada
              </button>
            ) : (
              <button
          ...
          <div className="py-9">{error.length > 0 ? error : info}</div>
        </div>
        {/* </form> */}
        <MapContainer
          style={{ height: 280 }}
